...
/**
 * The type testcheck.lib.Answer. Contains text of an answer plus a boolean value indicating whether its correct or not.
 */
@XmlRootElement
...
public class Answer
{
    ...
    /**
     * Instantiates a new testcheck.lib.Answer.
     *
