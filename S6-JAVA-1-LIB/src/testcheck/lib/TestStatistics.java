...
/**
 * The type testcheck.lib.TestStatistics contains various data used in graphs.
 * It also connects testcheck.lib.Test with TestResults and calls interaction between them.
 */
public class TestStatistics
{
    ...
    /**
     * Instantiates a new testcheck.lib.Test statistics.
     *
     * @param test the test
     */
